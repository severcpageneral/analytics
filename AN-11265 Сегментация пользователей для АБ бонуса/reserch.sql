         ...
         WHERE server_upload_time >= '2024-09-01'
           AND event_type IN ('registration_form_view', 'registration_tab_change', 'registration_password_field', 'registration_email_field', 'registration_phone_field')
